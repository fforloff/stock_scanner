class Google_drive
  ...
  # def get_parent_id(parent_folders)
  #   parent_id = nil
  #   parent_folders = [parent_folders] if parent_folders.is_a?(String)
  #   return perent_id if parent_folders.length == 0
  #   parent_folders.each do |folder|
  #     res = self.get_file_id(folder)
  #     parent_id = res unless res == nil
  #   end
  #   parent_id 
  # end
